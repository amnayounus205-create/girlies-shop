    ...
    <main className="relative min-h-screen w-full overflow-x-hidden bg-[#fff8fb] text-gray-900 selection:bg-pink-500 selection:text-white">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
            {categories.map((category, index) => (
              ...
              >
                ...
                >
                  <div className="relative h-[230px] overflow-hidden bg-gradient-to-br from-pink-50 via-white to-rose-50">
                    <motion.img
                      src={category.image}
                      alt={category.name}
                  ...
                  <div className="p-6">
                    <div className="flex items-center justify-between gap-3">
                      <div>
                        <h3 className="text-lg font-black text-gray-950 transition-colors group-hover:text-pink-600">
                          {category.name}
                        </h3>
                      ...
                      <motion.span 
                        ...
                        className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-pink-50 text-sm text-pink-600 group-hover:bg-pink-600 group-hover:text-white transition-colors"
                      >
                        →
                      </motion.span>
                    </div>
      ...
      <section className="relative z-10 px-5 sm:px-8">
        <motion.div 
          ...
          className="relative mx-auto max-w-6xl overflow-hidden rounded-3xl bg-gradient-to-r from-pink-500 via-pink-600 to-rose-500 px-7 py-12 shadow-2xl shadow-pink-300/50 sm:px-12"
        >
          <motion.div 
          ...
          <div className="relative flex flex-col items-center justify-between gap-7 text-center md:flex-row md:text-left">
            <div>
              ...
              <h2 className="mt-2 text-2xl font-black text-white sm:text-3xl">Something pretty just arrived.</h2>
              <p className="mt-2 text-sm text-pink-100">Explore our latest collection before it's gone.</p>
            </div>
            
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                to="/shop"
                className="group inline-flex items-center rounded-full bg-white px-7 py-3.5 text-sm font-bold text-pink-600 shadow-lg transition-colors hover:bg-gray-950 hover:text-white"
              >
      ...
      <section className="relative z-10 mx-auto max-w-6xl px-5 py-24 sm:px-8">
        ...
        >
          ...
          <h2 className="mt-3 text-3xl font-black text-gray-950 sm:text-4xl">Why Girlies Shop?</h2>
          <p className="mx-auto mt-3 max-w-md text-sm text-gray-500">Everything you need for a smooth shopping experience.</p>
        </motion.div>
          ...
          {features.map((feature, index) => (
            ...
            >
              <motion.div 
                ...
                className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-pink-100 to-rose-100 text-2xl shadow-sm"
              >
                {feature.icon}
              </motion.div>
              <h3 className="mt-4 font-bold text-gray-900">{feature.title}</h3>
              <p className="mx-auto mt-2 max-w-xs text-xs leading-5 text-gray-500">{feature.description}</p>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      {/* =====================================================
          NEWSLETTER
      ===================================================== */}
      <section className="relative z-10 overflow-hidden border-y border-pink-100 bg-gradient-to-br from-pink-50/90 via-white to-rose-50/90 py-20">
        <div className="relative mx-auto max-w-5xl px-5 text-center sm:px-8">
          <motion.div 
            ...
            className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-white text-2xl shadow-md shadow-pink-100"
          >
            💌
          </motion.div>
          ...
          <motion.h2 
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="mt-5 text-3xl font-black text-gray-950 sm:text-4xl"
          >
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              type="button"
              className="rounded-full bg-gray-950 px-7 py-3.5 text-sm font-bold text-white shadow-lg transition-colors hover:bg-pink-600"
            >
              Subscribe
            </motion.button>
          </motion.div>
          <p className="mt-3 text-[11px] text-gray-400">No spam. Just pretty things and occasional offers.</p>
        </div>
      </section>
      ...
      {/* =====================================================
          FINAL CTA
      ===================================================== */}
      <section className="relative z-10 overflow-hidden bg-gradient-to-b from-white via-[#fff9fc] to-pink-50/70 py-20">
        <motion.div 
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        ...
        >
          <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-pink-100 to-rose-100 text-pink-500 shadow-sm">
            ✦
          </div>
          <h2 className="mt-5 text-2xl font-black tracking-tight text-gray-950 sm:text-3xl">
            Find something that feels like you.
          </h2>
          <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-gray-500">Your style. Your mood. Your little moment.</p>

          <motion.div whileHover={{ scale: 1.06 }} whileTap={{ scale: 0.95 }} className="inline-block mt-7">
            <Link
              to="/shop"
              className="group inline-flex items-center rounded-full bg-gradient-to-r from-pink-500 to-rose-500 px-8 py-4 text-sm font-bold text-white shadow-lg shadow-pink-200 transition-all hover:shadow-xl hover:from-pink-600 hover:to-rose-600"
            >
