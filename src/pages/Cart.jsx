...
function Cart() {
  ...
  if (cart.length === 0) {
    return (
      <main className="relative min-h-screen overflow-hidden bg-[#fff7fb]">
        ...
        <div className="pointer-events-none fixed -left-40 -top-40 h-[500px] w-[500px] rounded-full bg-pink-200/35 blur-[120px]" />

        <div className="pointer-events-none fixed -right-40 top-20 h-[500px] w-[500px] rounded-full bg-rose-200/30 blur-[120px]" />
        ...
        <div className="relative z-10 mx-auto flex min-h-screen max-w-4xl items-center justify-center px-5 py-16">
          ...
          <div className="relative w-full overflow-hidden rounded-[35px] border border-pink-100 bg-white/80 px-6 py-16 text-center shadow-[0_25px_80px_rgba(244,114,182,0.12)] backdrop-blur-xl sm:px-12">

            {/* Decorative circles */}
            <div className="pointer-events-none absolute -right-24 -top-24 h-64 w-64 rounded-full bg-pink-200/30 blur-3xl" />
            ...
            <div className="relative">
              ...
              <span className="mt-7 inline-flex rounded-full bg-pink-50 px-4 py-2 text-[9px] font-bold uppercase tracking-[0.25em] text-pink-600">
              ...
              <p className="mx-auto mt-4 max-w-md text-sm leading-6 text-gray-500">
                Looks like you haven't added any sweet pink treats to your
                cart yet. Let's find something beautiful for you.
              </p>

              <Link
                to="/shop"
                className="mt-8 inline-flex items-center justify-center rounded-full bg-gradient-to-r from-pink-500 via-pink-600 to-rose-500 px-8 py-3.5 text-sm font-bold text-white shadow-lg shadow-pink-200 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-pink-300"
              >
                Start Shopping
                <span className="ml-2">
                  🛍️
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#fff7fb]">
      ...
      {/* Decorative dots */}
      <div className="pointer-events-none fixed left-[8%] top-[30%] h-2 w-2 rounded-full bg-pink-400/40" />
      <div className="pointer-events-none fixed right-[12%] top-[40%] h-3 w-3 rounded-full bg-rose-400/30" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 py-10 sm:px-6 sm:py-14 lg:px-8">
        ...
        <div className="mb-10 text-center">
          ...
          <span className="inline-flex items-center gap-2 rounded-full border border-pink-100 bg-white/80 px-4 py-2 text-[9px] font-bold uppercase tracking-[0.25em] text-pink-600 shadow-sm backdrop-blur">
            💗 Your Collection
          </span>
        ...
        <div className="grid grid-cols-1 gap-7 lg:grid-cols-[1fr_360px]">
          ...
          <section className="relative overflow-hidden rounded-[28px] border border-pink-100 bg-white/85 p-4 shadow-[0_15px_50px_rgba(244,114,182,0.08)] backdrop-blur-xl sm:p-6">
            ...
            <div className="relative">
              ...
              <div className="mb-6 flex items-center justify-between border-b border-pink-100 pb-5">
                ...
                <div className="rounded-full bg-gradient-to-r from-pink-50 to-rose-50 px-4 py-2 text-xs font-bold text-pink-600">
              ...
              <div className="space-y-4">
                ...
                {cart.map((item, index) => (
                  ...
                  <div
                    key={item.id}
                    className="group relative overflow-hidden rounded-2xl border border-pink-100/80 bg-gradient-to-r from-white to-pink-50/30 p-3 transition-all duration-300 hover:-translate-y-0.5 hover:border-pink-200 hover:shadow-lg hover:shadow-pink-100/60 sm:p-4"
                    style={{
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="flex items-start justify-between gap-3">
                          ...
                          <button
                            ...
                            className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-gray-50 text-gray-400 transition-all duration-300 hover:scale-110 hover:bg-red-50 hover:text-red-500"
                        ...
                        <div className="mt-4 flex items-center justify-between gap-3">
                          ...
                          <div className="flex items-center rounded-full border border-pink-100 bg-white shadow-sm">
                            ...
                            <button
                              ...
                              className="flex h-8 w-8 items-center justify-center rounded-full text-sm font-bold text-pink-600 transition hover:bg-pink-50"
                            >
                              −
                            </button>
          ...
          <aside className="lg:sticky lg:top-24 lg:self-start">
            ...
            <div className="relative overflow-hidden rounded-[28px] border border-pink-100 bg-gradient-to-br from-white via-pink-50/70 to-rose-50/80 p-6 shadow-[0_20px_60px_rgba(244,114,182,0.12)]">
              ...
              <div className="relative">
                ...
                <div className="mb-6">
                  ...
                  <span className="text-[9px] font-bold uppercase tracking-[0.25em] text-pink-500">
                    Almost there
                  </span>
                ...
                <Link
                  to="/checkout"
                  className="mt-5 flex w-full items-center justify-center rounded-full bg-gradient-to-r from-pink-500 via-pink-600 to-rose-500 px-6 py-4 text-sm font-bold text-white shadow-lg shadow-pink-200 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-pink-300"
                >
                  Proceed to Checkout
                  <span className="ml-2">
                    →
