...
function Register() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#fff7fb]">
      ...
      {/* Decorative circles */}
      <div className="pointer-events-none absolute left-[8%] top-[20%] h-3 w-3 rounded-full bg-pink-400/40" />

      <div className="pointer-events-none absolute right-[12%] top-[30%] h-2 w-2 rounded-full bg-rose-400/40" />

      <div className="pointer-events-none absolute bottom-[20%] left-[15%] h-2 w-2 rounded-full bg-pink-300/50" />
      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-6xl items-center justify-center px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="grid w-full max-w-5xl overflow-hidden rounded-[32px] border border-pink-100 bg-white/75 shadow-[0_30px_100px_rgba(244,114,182,0.15)] backdrop-blur-xl lg:grid-cols-[0.85fr_1.15fr]">
          ...
          <div className="relative hidden overflow-hidden bg-gradient-to-br from-pink-500 via-pink-600 to-rose-500 p-10 lg:flex lg:flex-col lg:justify-between">
            ...
            {/* Decorative glow */}
            <div className="pointer-events-none absolute -right-28 -top-28 h-72 w-72 rounded-full bg-white/10 blur-2xl" />
            ...
            <div className="relative">
              ...
              <div className="mt-20">
                ...
                <p className="mt-5 max-w-sm text-sm leading-6 text-pink-100">
                  Create your account and discover a curated world of
                  beautiful accessories, jewelry and everyday essentials.
                </p>
            ...
            <div className="relative mt-12 space-y-4">
              ...
              <div className="flex items-center gap-3 rounded-2xl bg-white/10 p-3 backdrop-blur-sm">
                ...
                <div>
                  ...
                  <p className="text-[9px] text-pink-100">
                    Pretty pieces, carefully selected
                  </p>
                </div>
              ...
              <div className="flex items-center gap-3 rounded-2xl bg-white/10 p-3 backdrop-blur-sm">
                ...
                <div>
                  ...
                  <p className="text-[9px] text-pink-100">
                    Because every detail should feel pretty
                  </p>
                </div>
          ...
          <div className="p-6 sm:p-10 lg:p-12">
            ...
            {/* Error */}
            {error && (
              <div className="mb-5 flex items-center gap-3 rounded-2xl border border-red-100 bg-red-50 px-4 py-3 text-xs font-semibold text-red-600">
            ...
            >
              ...
              {/* Terms */}
              <div className="flex items-start gap-3 rounded-2xl bg-pink-50/50 p-3.5">

                <div className="mt-0.5 flex h-4 w-4 shrink-0 items-center justify-center rounded-full bg-pink-500 text-[9px] text-white">
                  ✓
                </div>

                <p className="text-[9px] leading-4 text-gray-500">
                  By creating an account, you agree to our shopping experience
                  and understand that your information will be handled securely.
                </p>
              ...
              <button
                type="submit"
                className="group relative w-full overflow-hidden rounded-2xl bg-gradient-to-r from-pink-500 via-pink-600 to-rose-500 py-4 text-sm font-bold text-white shadow-lg shadow-pink-200 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-pink-300 active:translate-y-0"
              >
            ...
            <div className="mt-7 text-center">
              ...
              <Link
                to="/login"
                className="mt-1 inline-block text-sm font-bold text-pink-600 transition hover:text-rose-500 hover:underline"
              >
            ...
            {/* Trust footer */}
            <div className="mt-8 flex items-center justify-center gap-5 border-t border-pink-100 pt-6">
